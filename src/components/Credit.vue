  ...
  <section class="rt-section">
    <div class="comment" v-for="comment in comments">
      ...
      <div class="comment-icon">
        <span v-if="comment.rate === 'good'" class="rti rti-2x rti-smile-o-success"></span>
        <span v-if="comment.rate === 'bad'" class="rti rti-2x rti-frown-o-important"></span>
        <span v-if="comment.rate === 'soso'" class="rti rti-2x rti-meh-o-inverse"></span>
      </div>
